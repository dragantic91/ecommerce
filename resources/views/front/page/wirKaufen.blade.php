                ...
                <main>
                    <section class="container stylization maincont">
                        ...
                        <div class="contactform-wrap">
                            <form action="{{ route('wir-kaufen.mail') }}" class="form-validate" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <p class="contactform-field contactform-textarea">
                                    <label class="contactform-label">Meine Frage</label><span class="contactform-input"><textarea placeholder="Ihre Nachricht" name="mess" data-required="text" required>{{ old('mess') }}</textarea></span>
                                </p>
                                <p class="contactform-field contactform-textarea">
                                    <label class="contactform-label">Bild senden</label><span class="contactform-input"><input type="file" name="image[]" multiple required></span>
                                </p>
